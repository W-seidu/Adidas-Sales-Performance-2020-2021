...
- In 2020 and 2021, total sales and operating profits consistently rose in the third quarter and then declined in the last quarter. The rise in the third quarter can be attributed to back-to-school and fall shopping, an important period when families purchase footwear and apparel for students. The last quarter fall is unusual as holiday seasons usually drive retail sales. The global sales team should further examine this pattern and seek ways to solve any problem discovered. More details on this will be in the recommendations section.
...
- Women’s athletic footwear was the least-performing product in both 2020 and 2021. This product made $11 million in sales (64,000 units), contributing 11% to total sales revenue. It also earned a profit of $4 million, again, contributing 11% to total operating profits.
- Using the two previous insights, one may be tempted to think that male products perform well and female products perform poorly. This is not the case. If we divided all products primarily into male and female products, in 2021, male products contributed 54% to total sales, while female products contributed 46% in the same year.
...
- The fact that men’s street footwear, women’s apparel, and women’s athletic footwear maintained the same position in 2020 and 2021 signals stability in consumer purchase behavior. The products ranking in 2020 and 2021 looks like this:  
  `{Insert a table showing the top 5 products for both years}`.  
...
### a. Address Declines in the Last Quarter of the Year
The last quarter of 2020 and 2021 saw a steep decline. This trend is unusual, as holiday seasons drive retail sales. The following strategies can solve this problem:
- Conduct a comprehensive consumer behavior analysis in the last quarter (Q4) of 2020 and 2021, focusing on missed opportunities during the holiday season. Of course, we could have done this analysis, but the scope of the data provided is inadequate. We will need more information on customer demographics, conversion rates from holiday-specific ads, and the performance of Black Friday and other sales campaigns in the last quarter, among other things.
- Use the information from the analysis to design improved promotional activities and targeted campaigns during Black Friday, Cyber Monday, and Christmas.
- Introduce holiday-exclusive collections or bundles to drive sales.

### b. Redefine Product Strategy for Women’s Athletic Footwear
...
### c. Leverage Stable Product Performance
...
### e. Address Midwest Underperformance
...
### g. Optimize Other Sales Channels
